                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-9 col-lg-9 col-md-9">
                                <div class="header-banner f-right ">
                                    <img src="${pageContext.request.contextPath}/resources/img/gallery/header_card.png" alt="">
                                </div>
                            </div>
                        </div>
                   </div>
                ...
                <div class="container">
                    <div class="row d-flex justify-content-between">
                            ...
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="whats-right-single mb-20">
                                    <div class="whats-right-img">
                                        <img src="${pageContext.request.contextPath}/resources/img/gallery/footer_post1.png" alt="">
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-5 col-sm-7">
                            <div class="single-footer-caption mb-50">
                                <div class="banner">
                                    <img src="${pageContext.request.contextPath}/resources/img/gallery/body_card4.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
